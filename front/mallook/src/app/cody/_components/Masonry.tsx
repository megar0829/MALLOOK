...
const Item = (props: { postData:ItemData }) => {
	...
	return (
		<div className={styles.item}>
				...
				<div className={styles.bottomDiv}>
					<div className={styles.bottomDiv__topDiv}>
						<div className={styles.bottomDiv__topDiv__leftDiv}>
							<Image
								className={styles.bottomDiv__topDiv__leftDiv__profileImage}
								src={props.postData.cody.profileImg}
								alt="프로필이미지"
							/>
							<span className={styles.bottomDiv__topDiv__leftDiv__username}>
                {props.postData.cody.username}
              </span>
						</div>
						<div className={styles.bottomDiv__topDiv__rightDiv}>
              <span className={styles.bottomDiv__topDiv__rightDiv__likeCnt}>
                {props.postData.cody.likeCnt}
              </span>
							<div
								className={styles.bottomDiv__topDiv__rightDiv__likeDiv}
								onClick={toggleLike}
							>
								{liked ? (
									<GoHeartFill
										className={styles.bottomDiv__topDiv__rightDiv__like}
										style={{ color: "#E7707C" }}
									/>
								) : (
									<GoHeart
            ...
            <span className={styles.bottomDiv__bottomDiv__content}>
              {props.postData.cody.content}
            </span>
					</div>
				</div>
			</div>
