	...
	return (
		<div className={styles.detailProductInformation__container}>
			<div className={styles.detailProductInformation__topDiv}>
				<button style={{color: isDetail ? "white" : "gray"}} className={styles.detailProductInformation__button} onClick={() => setIsDetail(true)}>상세정보</button>
				<div className={styles.detailProductInformation__line}></div>
				<button style={{color: !isDetail ? "white" : "gray"}} className={styles.detailProductInformation__button} onClick={() => setIsDetail(false)}>리뷰</button>
			</div>
			{information()}
		</div>
	);
